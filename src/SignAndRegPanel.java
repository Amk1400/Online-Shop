...
public abstract class SignAndRegPanel extends ParentPanel{
    ...
    protected User getInputUser() throws SQLException {
        return new User(usernameField.getText(), String.valueOf(passwordField.getText().hashCode()), DataBase.getAddress(usernameField.getText()),DataBase.getPhone(usernameField.getText()),DataBase.getWallet(usernameField.getText()));
    }
